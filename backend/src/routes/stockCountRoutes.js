...
const {
  startOrGetOpenCount, getCount, saveItem, finalizeCount, getReport,
...
router.post('/:id/finalize', requireRole('proprietario'), asyncHandler(finalizeCount));
router.get('/:id/report', requireRole('proprietario'), asyncHandler(getReport));
